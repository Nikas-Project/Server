    ...
    function ($, utils, config, api, jade, i18n, lib, globals) {
        ...
        var insert_loader = function (comment, lastcreated) {
            ...
            if (comment.id === null) {
                ...
                entrypoint = $("#nikas-" + comment.id + " > .text-wrapper > .nikas-follow-up");
        ...
        var insert = function (comment, scrollIntoView) {
            ...
            if (comment.parent === null) {
                ...
                entrypoint = $("#nikas-" + comment.parent + " > .text-wrapper > .nikas-follow-up");
            }
            ...
            var footer = $("#nikas-" + comment.id + " > .text-wrapper > .nikas-comment-footer"),
                header = $("#nikas-" + comment.id + " > .text-wrapper > .nikas-comment-header"),
