...
class TestComments(unittest.TestCase):
    ...
    def testVerifyFields(self):
        ...
        self.assertTrue(comments.isurl(
            "https://example.tld:1337/foobar?p=1#nikas-thread"))
...
<feed xmlns="http://www.w3.org/2005/Atom" xmlns:thr="http://purl.org/syndication/thread/1.0"><updated>1970-01-01T01:00:00Z</updated><id>tag:example.org,2018:/nikas/thread/path/nothing</id><title>Comments for example.org/path/nothing</title></feed>""")
...
<feed xmlns="http://www.w3.org/2005/Atom" xmlns:thr="http://purl.org/syndication/thread/1.0"><updated>2018-04-01T10:00:00Z</updated><id>tag:example.org,2018:/nikas/thread/path/</id><title>Comments for example.org/path/</title><entry><id>tag:example.org,2018:/nikas/1/2</id><title>Comment #2</title><updated>2018-04-01T10:00:00Z</updated><author><name /></author><link href="https://example.org/path/#nikas-2" /><content type="html">&lt;p&gt;&lt;em&gt;Second&lt;/em&gt;&lt;/p&gt;</content><thr:in-reply-to href="https://example.org/path/#nikas-1" ref="tag:example.org,2018:/nikas/1/1" /></entry><entry><id>tag:example.org,2018:/nikas/1/1</id><title>Comment #1</title><updated>2018-04-01T10:00:00Z</updated><author><name /></author><link href="https://example.org/path/#nikas-1" /><content type="html">&lt;p&gt;First&lt;/p&gt;</content></entry></feed>""", """<?xml version=\'1.0\' encoding=\'utf-8\'?>
<feed xmlns="http://www.w3.org/2005/Atom" xmlns:thr="http://purl.org/syndication/thread/1.0"><updated>2018-04-01T10:00:00Z</updated><id>tag:example.org,2018:/nikas/thread/path/</id><title>Comments for example.org/path/</title><entry><id>tag:example.org,2018:/nikas/1/2</id><title>Comment #2</title><updated>2018-04-01T10:00:00Z</updated><author><name /></author><link href="https://example.org/path/#nikas-2" /><content type="html">&lt;p&gt;&lt;em&gt;Second&lt;/em&gt;&lt;/p&gt;</content><thr:in-reply-to ref="tag:example.org,2018:/nikas/1/1" href="https://example.org/path/#nikas-1" /></entry><entry><id>tag:example.org,2018:/nikas/1/1</id><title>Comment #1</title><updated>2018-04-01T10:00:00Z</updated><author><name /></author><link href="https://example.org/path/#nikas-1" /><content type="html">&lt;p&gt;First&lt;/p&gt;</content></entry></feed>"""])
...
class TestHostDependent(unittest.TestCase):
    ...
    def testSecureCookieNoConf(self):
        self.app.wsgi_app = FakeHost(self.app.wsgi_app, "nikas-dev.local", "https")
        rv = self.post('/new?uri=%2Fpath%2F',
                       data=json.dumps({'text': 'Lorem ipsum ...'}))
    ...
    def testInSecureCookieNoConf(self):
        self.app.wsgi_app = FakeHost(self.app.wsgi_app, "nikas-dev.local", "http")
        rv = self.post('/new?uri=%2Fpath%2F',
                       data=json.dumps({'text': 'Lorem ipsum ...'}))
    ...
    def testSameSiteConfNone(self):
        # By default, nikas should set SameSite=Lax when served over http
        self.app.wsgi_app = FakeHost(self.app.wsgi_app, "nikas-dev.local", "http")
    ...
    def testSameSiteConfLax(self):
        # By default, nikas should set SameSite=None when served over https
        self.app.wsgi_app = FakeHost(self.app.wsgi_app, "nikas-dev.local", "https")
        # Conf overrides SameSite setting
...
class TestModeratedComments(unittest.TestCase):
    ...
    def testModerateComment(self):
        ...
        self.assertIn(b"http://invalid.local/moderated#nikas-1", rv_activate_get.data)
